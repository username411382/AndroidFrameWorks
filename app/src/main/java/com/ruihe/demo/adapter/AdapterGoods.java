...
public class AdapterGoods extends BaseAdapter implements StickyListHeadersAdapter {

    private ArrayList<GoodsItem> dataList;
    private ActivityShoppingCart mContext;
    private NumberFormat nf;
    private LayoutInflater mInflater;

    public AdapterGoods(ArrayList<GoodsItem> dataList, ActivityShoppingCart mContext) {
    ...
    class ItemViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ActivityShoppingCart activity = mContext;
            switch (v.getId()) {
                case R.id.tvAdd: {
