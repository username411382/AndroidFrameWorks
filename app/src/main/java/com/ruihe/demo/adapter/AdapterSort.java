...
import com.ruihe.demo.common.utils.view.ImageTextView;
 ...
 * 用来处理集合中数据的显示与排序
 */
public class AdapterSort extends BaseAdapter implements SectionIndexer {
    private List<SortModel> list = null;
    private Context mContext;

    public AdapterSort(Context mContext, List<SortModel> list) {
