...
public class AutoScrollViewPager extends ViewPager {
     ...
     * @param viewPager
     * @param indicator
     * @param indicatorFillColor   指示器选中时的颜色
     * @param indicatorEmptyColor  指示器空状态时的颜色
     * @param indicatorStrokeColor 指示器边缘颜色
     * @param indicatorStrokeWidth 指示器边缘宽度
     */
    public void setIndicator(ViewPager viewPager, CirclePageIndicator indicator,
                             int indicatorFillColor, int indicatorEmptyColor, int indicatorStrokeColor, float indicatorStrokeWidth) {

        indicator.setViewPager(viewPager);
        indicator.setSnap(true);
        indicator.setFillColor(indicatorFillColor);
        indicator.setPageColor(indicatorEmptyColor);
        indicator.setStrokeColor(indicatorStrokeColor);
