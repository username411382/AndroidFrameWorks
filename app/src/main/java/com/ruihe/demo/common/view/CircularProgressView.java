...
public class CircularProgressView extends View {
    ...
    private static final float INDETERMINANT_MIN_SWEEP = 35f;
    ...
    private void initAttributes(AttributeSet attrs, int defStyle) {
        ...
        currentProgress = a.getFloat(R.styleable.CircularProgressView_cpv_progress,
                resources.getInteger(R.integer.cpv_default_progress));//本身在Values
        ...
        isCapRound = a.getBoolean(R.styleable.CircularProgressView_cpv_capRound,
                resources.getBoolean(R.bool.cpv_default_cap_round));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!isIndeterminate)
            canvas.drawArc(bounds, startAngle - 90, sweepAngle, false, paint);
        else
            canvas.drawArc(bounds, startAngle + indeterminateRotateOffset - 90, indeterminateSweep, false, paint);
    }
