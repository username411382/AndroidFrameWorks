...
public class VideoView extends SurfaceView implements
    ...
    private OnHideVideoLoadingStatus mOnHideLoadingStatus;
    ...
    public void setMediaBufferingIndicator(View mediaBufferingIndicator, OnHideVideoLoadingStatus onHideVideoLoadingStatus) {
        if (mMediaBufferingIndicator != null)
            mMediaBufferingIndicator.setVisibility(View.GONE);
        mMediaBufferingIndicator = mediaBufferingIndicator;
        mOnHideLoadingStatus = onHideVideoLoadingStatus;
    }
    ...
    private OnErrorListener mErrorListener = new OnErrorListener() {
        public boolean onError(IMediaPlayer mp, int framework_err, int impl_err) {
            ...
            if (getWindowToken() != null) {
                ...
                mDialog = DialogUtils.createAlertDialogWithTitle(mContext, getResources().getString(R.string.vitamio_videoview_error_title), getResources().getString(message), new DialogUtils.OnDialogButtonClickListener() {
                    @Override
                    public void onConfirm() {
                        if (mOnCompletionListener != null)
                            mOnCompletionListener
                                    .onCompletion(mMediaPlayer);
                        mOnHideLoadingStatus.hideVideoLoadingStatus();
                        mDialog.dismiss();
    ...
    public interface OnHideVideoLoadingStatus {
        void hideVideoLoadingStatus();
    }
