...
public class MediaController extends FrameLayout {
    ...
    public void setTitleTopView(View titleTopView) {
        this.mTitleTopView = titleTopView;
    }
    ...
    public void show(int timeout) {
        if (!mShowing && mAnchor != null && mAnchor.getWindowToken() != null) {
            ...
            if (mFromXml) {
                ...
                mWindow.setAnimationStyle(R.style.video_controller_bar_bottom);
                mWindow.showAtLocation(mAnchor, Gravity.BOTTOM,
                        anchorRect.left, 0);
            }

            if (mTitleTopView.getVisibility() != VISIBLE) {
                mTitleTopView.setVisibility(View.VISIBLE);
                translateAnimation(mTitleTopView, 0f, 0f, -1.0f, 0f, 300);
            }
    ...
    public void hide() {
        ...
        if (mShowing) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH && getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
            ...
            try {
                ...
                translateAnimation(mTitleTopView, 0f, 0f, 0f, -1.0f, 300);
                mTitleTopView.setVisibility(View.GONE);
    ...
    private void updatePausePlay() {
        ...
        if (mPlayer.isPlaying())
            mPauseButton
                    .setImageResource(R.drawable.ic_video_play_pause);
        else
            mPauseButton
                    .setImageResource(R.drawable.ic_video_play_start);
    }
