...
import com.ruihe.demo.adapter.AdapterGoods;
import com.ruihe.demo.adapter.AdapterSelect;
...
public class ActivityShoppingCart extends BaseActivity implements View.OnClickListener {
    ...
    private AdapterGoods myAdapter;
    private AdapterSelect selectAdapter;
    private AdapterType typeAdapter;
    ...
    public static void redirectToActivity(Context context) {
        Intent intent = new Intent(context, ActivityShoppingCart.class);
    ...
    private void initView() {
        ...
        typeAdapter = new AdapterType(this, typeList);
        rvType.setAdapter(typeAdapter);
        rvType.addItemDecoration(new DividerDecoration(this));

        myAdapter = new AdapterGoods(dataList, this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.clear:
                ...
                break;
            case R.id.tvSubmit:
                Toast.makeText(ActivityShoppingCart.this, "结算", Toast.LENGTH_SHORT).show();
                break;
            default:
                break;
        }
